  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-zinc-950 text-white overflow-hidden font-sans">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 flex flex-col items-center gap-6 bg-zinc-950 scrollbar-thin">
          {activeRangeNode ? (
            <>
              {/* Active Chart Header Bar */}
              <div className="w-full max-w-[780px] flex items-center justify-between border-b border-zinc-900 pb-3">
                <div>
                  ...
                  <p className="text-xs text-zinc-400">
                    {isViewMode ? 'Режим просмотра диапазона' : 'Редактирование чарта рук'}
                  </p>
                </div>
